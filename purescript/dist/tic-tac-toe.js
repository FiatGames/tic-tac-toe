...
(function(exports) {
  ...
  var eqSpot = new Data_Eq.Eq(function (x) {
      return function (y) {
          if (x instanceof UL && y instanceof UL) {
              return true;
          };
          if (x instanceof UM && y instanceof UM) {
              return true;
          };
          if (x instanceof UR && y instanceof UR) {
              return true;
          };
          if (x instanceof ML && y instanceof ML) {
              return true;
          };
          ...
          if (x instanceof DM && y instanceof DM) {
              return true;
          };
          if (x instanceof DR && y instanceof DR) {
              return true;
          };
          return false;
      };
...
(function(exports) {
  ...
  var component = (function () {
      var pl = function (v) {
          ...
          if (v.value1 instanceof Data_Maybe.Just && v.value1.value0 instanceof TicTacToe_Types.O) {
              return "O";
          };
          if (v.value1 instanceof Data_Maybe.Just && v.value1.value0 instanceof TicTacToe_Types.X) {
              return "X";
          };
          throw new Error("Failed pattern match at Display line 61, column 3 - line 62, column 3: " + [ v.constructor.name ]);
      };
      var render = function (v) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "container-fluid" ]) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "row" ]) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "col-sm-4" ]), Halogen_HTML_Properties.attr("style")("text-align:center;") ])([ Halogen_HTML_Core.text(Data_Maybe.maybe("")(pl)(Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Array.findIndex(function (v1) {
              return Data_Eq.eq(TicTacToe_Types.eqSpot)(v1.value0)(TicTacToe_Types.UL.value);
          })(v.board))(Data_Array.index(v.board)))) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "col-sm-4" ]), Halogen_HTML_Properties.attr("style")("text-align:center;") ])([ Halogen_HTML_Core.text(Data_Maybe.maybe("")(pl)(Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Array.findIndex(function (v1) {
              return Data_Eq.eq(TicTacToe_Types.eqSpot)(v1.value0)(TicTacToe_Types.UM.value);
          })(v.board))(Data_Array.index(v.board)))) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "col-sm-4" ]), Halogen_HTML_Properties.attr("style")("text-align:center;") ])([ Halogen_HTML_Core.text(Data_Maybe.maybe("")(pl)(Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Array.findIndex(function (v1) {
              return Data_Eq.eq(TicTacToe_Types.eqSpot)(v1.value0)(TicTacToe_Types.UR.value);
          })(v.board))(Data_Array.index(v.board)))) ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "row" ]) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "col-sm-4" ]), Halogen_HTML_Properties.attr("style")("text-align:center;") ])([ Halogen_HTML_Core.text(Data_Maybe.maybe("")(pl)(Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Array.findIndex(function (v1) {
              return Data_Eq.eq(TicTacToe_Types.eqSpot)(v1.value0)(TicTacToe_Types.ML.value);
          })(v.board))(Data_Array.index(v.board)))) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "col-sm-4" ]), Halogen_HTML_Properties.attr("style")("text-align:center;") ])([ Halogen_HTML_Core.text(Data_Maybe.maybe("")(pl)(Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Array.findIndex(function (v1) {
              return Data_Eq.eq(TicTacToe_Types.eqSpot)(v1.value0)(TicTacToe_Types.MM.value);
          })(v.board))(Data_Array.index(v.board)))) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "col-sm-4" ]), Halogen_HTML_Properties.attr("style")("text-align:center;") ])([ Halogen_HTML_Core.text(Data_Maybe.maybe("")(pl)(Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Array.findIndex(function (v1) {
              return Data_Eq.eq(TicTacToe_Types.eqSpot)(v1.value0)(TicTacToe_Types.MR.value);
          })(v.board))(Data_Array.index(v.board)))) ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "row" ]) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "col-sm-4" ]), Halogen_HTML_Properties.attr("style")("text-align:center;") ])([ Halogen_HTML_Core.text(Data_Maybe.maybe("")(pl)(Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Array.findIndex(function (v1) {
              return Data_Eq.eq(TicTacToe_Types.eqSpot)(v1.value0)(TicTacToe_Types.DL.value);
          })(v.board))(Data_Array.index(v.board)))) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "col-sm-4" ]), Halogen_HTML_Properties.attr("style")("text-align:center;") ])([ Halogen_HTML_Core.text(Data_Maybe.maybe("")(pl)(Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Array.findIndex(function (v1) {
              return Data_Eq.eq(TicTacToe_Types.eqSpot)(v1.value0)(TicTacToe_Types.DM.value);
          })(v.board))(Data_Array.index(v.board)))) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "col-sm-4" ]), Halogen_HTML_Properties.attr("style")("text-align:center;") ])([ Halogen_HTML_Core.text(Data_Maybe.maybe("")(pl)(Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Array.findIndex(function (v1) {
              return Data_Eq.eq(TicTacToe_Types.eqSpot)(v1.value0)(TicTacToe_Types.DR.value);
...
(function(exports) {
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Control_Monad_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (v) {
      return Halogen_VDom_Driver.runUI(Display.component)(Data_Either.fromRight()(gameOver))(v);
  }));
